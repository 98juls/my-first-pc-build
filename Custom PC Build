...
PSU: GameMax GP850 80+ Bronze 850W
...
Fix: Reseated RAM → still no display

Issue 2: No display on second boot
Symptoms: Fans spinning but black screen
Cause: GPU not fully inserted into PCIe slot
Fix: Reseated GPU → system posted successfully and BIOS displayed

Issue 3: Unable to install Windows 11
Symptoms: System boots into BIOS but Windows installer not running correctly
Cause: Compatibility issue related to motherboard
